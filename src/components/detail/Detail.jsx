    ...
    <DetailStyled>
        ...
        <WineData>
          ...
          <div className="column">
            ...
            <div className="btns">
             <ButtonAddToCart style={ {transform: "scale(1.5)", margin: "1.2rem"}}>Add to Cart</ButtonAddToCart>
              <ButtonBuyNow style={ {transform: "scale(1.5)", margin: "1.2rem"}}>Buy now</ButtonBuyNow> 
            </div>
